...
function AboutUs() {
    return (
        <div className="about-us-container">
            ...
            <p className="about-us-description">Welcome to Verdant Vibes, where green meets serenity!</p>
            <p className="about-us-content">
                At Verdant Vibes, we are passionate about bringing nature closer to you. Our mission is to provide a wide range of
            ...
            <p className="about-us-content">
                Join us in our mission to create a greener, healthier world. Visit Verdant Vibes today and experience the
